...
var SlideContainer = /** @class */ (function (_super) {
    ...
    SlideContainer.prototype.constructView = function (constructor) {
        ...
        this.on(absolute_layout_1.AbsoluteLayout.loadedEvent, function (data) {
            ...
            if (!_this._loaded) {
                _this._loaded = true;
                if (_this.angular === true &&
                    constructor === true) {
                    return;
                }
                var slides_1 = [];
                if (!_this.slideWidth) {
                    _this.slideWidth = String(_this.pageWidth);
                }
                    ...
                    app.on(app.orientationChangedEvent, function () {
                        ...
                        setTimeout(function () {
                            ...
                            _this.eachLayoutChild(function (view) {
                                if (view instanceof
                                    stack_layout_1.StackLayout) {
                                    absolute_layout_1.AbsoluteLayout.setLeft(view, _this
                                        .pageWidth);
                                    view.width = _this.pageWidth;
                                }
                            });
            ...
            if (args.state ===
                ...
                if (_this.transitioning === false) {
                    ...
                    if (_this.hasPrevious) {
                        ...
                        if (app.ios)
                            _this.currentPanel.left.panel.translateX = -_this
                                .pageWidth;
                    }
                    if (app.ios)
                        _this.currentPanel.panel.translateX = -_this
                            .pageWidth;
                    _this.transitioning = false;
                }
            }
                ...
                if (!_this.transitioning &&
                    ...
                    if (_this.hasNext) {
                        ...
                        _this.currentPanel.panel.translateX =
                            args.deltaX - _this.pageWidth;
                        _this.currentPanel.right.panel.translateX =
                            args.deltaX;
                    }
                }
